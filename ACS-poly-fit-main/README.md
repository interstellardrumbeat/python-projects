# Polynomial fit for Absorbtion Cross Sections
...
### Info file  
The info file read by the software has two sections:    
...
* **Range for fit (in wavenumber, cm-1):** mininum and maximum wavenumber the fit will use (eg. 6076.200 6077.600)  
    **OPTIONAL**: multiple ranges can be given here in the form "min max min max" (eg. 607.6 607.7 608.1 608.2)  
        the software will then read these and the user can select which region use for the fit  
        inside of the main function (default: region = 0, i.e. the first pair of wavenumbers given)   
* **Degree of polynomial for Pressure:** an integer defining the degree of the polynomial in P (eg. 4)  
* **Degree of polynomial for Temperature:** an integer defining the degree of the polynomial in P (eg. 2)  
